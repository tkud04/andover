...
<div class="main">
  ...
  <!-- BANNER STRAT -->
  <section class="container-full-sm mb-30 mt-0 pt-0 pt-md-4 mt-md-2">
    <div class="container">
      <div class="row position-r">
        <div class="col-xl-2 col-lg-3 col-lgmd-20per height-sm-0 position-initial">
                ...
                <div id="menu" class="navbar-collapse collapse" >
                  <div class="middle-link mobile right-side">
                    <ul>
                      ...
                      <li class="gift-icon">
                        <a href="" title="Gift card"><span></span></a>
                      </li>
                    </ul>
                  </div>
                  <ul class="nav navbar-nav ">
                    ...
                    <li class="level d-block d-lg-none d-xl-block">
                    ...
                    <li class="level d-block d-lg-none d-xl-block hidden-cet"><a href="shop.html" class="page-scroll"><i class="fa fa-headphones"></i>Headphone (12)</a></li>
                    <li class="level">
                      <a href="shop.html" class="page-scroll"><i class="fa fa-microphone"></i>Accessories (70)</a>
                    </li>
                    <li class="level d-block d-lg-none d-xl-block hidden-cet"><a href="shop.html" class="page-scroll"><i class="fa fa-bolt"></i>Printers & Ink</a></li>
        ...
        <div class="col-xl-8 col-lg-9 col-lgmd-80per">
          <div class="banner">
                      ...
                      <div class="row">
                        <div class="col-md-9 col-8">
                          <div class="banner-detail-inner"> 
                            ...
                            <h1 class="banner-title">Top Branded for <br>headphone</h1>
                            <span class="offer">best selling, and popular.</span>
                          </div>
                          <a class="btn btn-color big" href="shop.html">Shop Now!</a>
                        </div>
                    ...
                    <div class="container">
                      <div class="row">
                        ...
                        <div class="col-md-9 col-9">
                          <div class="banner-detail-inner"> 
                            <span class="slogan">curved tv</span>
                            <h1 class="banner-title">Get latest TV models </h1>
                            <span class="offer">Get the top brands for TV</span> 
                          </div>
                            <a class="btn btn-color big" href="shop.html">Shop Now!</a>
                        </div>              
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-9 col-8">
                          <div class="banner-detail-inner"> 
                            ...
                            <h1 class="banner-title">drone cameras</h1>
                            <span class="offer">The latest camera up to 30% off</span> 
                          </div> 
                            <a class="btn btn-color big" href="shop.html">Shop Now!</a>
                        </div>
                        <div class="col-md-3 col-4"></div>
        ...
        <div class="col-xl-2 col-md-0">
          <div class="right-small-banner d-none d-xl-block">
            <a >
              <img src="images/right.banner.jpg" alt="Electrro">
            </a>
          </div>
        </div>
      </div>
  ...
  <section>
    <div class="container">
      <div class="row">
        <div class="col-xl-10 col-lg-9 col-lgmd-80per order-lg-2">
          <!-- SUB-BANNER START -->
                ...
                <div class="row">
                  <div class="col-lg-4 col-md-4 ">
                    <div class="sub-banner sub-banner1" >
                      ...
                      <div class="sub-banner-detail">
                        <div class="sub-banner-title sub-banner-title-color">Speaker</div>
                        <div class="sub-banner-subtitle">Wireless Bluetooth </div>
                      ...
                      <div class="sub-banner sub-banner2">
                        ...
                        <div class="sub-banner-detail">
                          <div class="video-block">
                            <a class="popup-youtube" href="https://vimeo.com/8658994">
                                <img alt="Electrro" src="images/you-tube-icon.png" draggable="false">
                            </a>
                          </div>
                  ...
                  <div class="col-lg-4 col-md-4 ">
                    <div class="sub-banner sub-banner3" >
                      ...
                      <div class="sub-banner-detail">
                        <div class="sub-banner-title sub-banner-title-color">Headphones</div>
                        <div class="sub-banner-subtitle">Powerful Sound</div>
                        <a class="btn btn-color " href="shop.html">Shop Now!</a>
                      </div>
                    </div>
                  </div>
          ...
          <div class="featured-product mtb-60">
            <div class="">
          ...
          <div class="ser-feature-block mtb-60">
            <div class="">
              <div class=" center-sm">
                <div class="row">
                  <div class="col-xl-4 service-box border-right">
        ...
        <div class="col-xl-2 col-lg-3 mb-sm-30 col-lgmd-20per mb-xs-30  order-lg-1">
          <div class="sidebar-block">
              ...
              <div class="sidebar-contant">
                <ul>
                  <li>
                    <div class="pro-media"> 
                      <a href="product-page.html">
                        <img alt="T-shirt" src="images/1.jpg">
                      </a> 
                    </div>
                    <div class="pro-detail-info"> 
                      <a href="product-page.html">Black African Print</a>
                  ...
                  <li>
                    <div class="pro-media"> 
                      <a href="product-page.html">
                        <img alt="T-shirt" src="images/2.jpg">
                      </a> 
                    </div>
                    <div class="pro-detail-info"> 
                      <a href="product-page.html">Black African Print</a>
                  ...
                  <li>
                    <div class="pro-media"> 
                      <a href="product-page.html">
                        <img alt="T-shirt" src="images/3.jpg">
                      </a> 
                    </div>
                    <div class="pro-detail-info"> 
                      <a href="product-page.html">Black African Print</a>
            ...
            <div class="sidebar-box sidebar-testimonial mb-40"><span class="opener plus"></span>
                <div class="sidebar-title d-block d-lg-none">
                  <h3>Testimonial</h3> <span></span>
                </div>
                <div class="client-main client-bg sidebar-contant">
                  <div class="client-inner align-center">
                    <div id="client" class="owl-carousel">
                      <div class="item client-detail">
                        ...
                        <div class="quote right-side">
                          ...
                          <div class="quote2-img">
                            <img src="images/home-quote2.png" alt="Electrro">
                          </div>
                        </div>
                      </div>
                      <div class="item client-detail">
                        <div class="client-img left-side ">
                            <img alt="Electrro" src="images/testimonial_img2.jpg"> 
                          <h4 class="sub-title client-title">- Joseph deboungawer - </h4>
                        </div>
                        <div class="quote right-side">
                          <div class="quote1-img">
                      ...
                      <div class="item client-detail">
                        <div class="client-img left-side ">
                            <img alt="Electrro" src="images/testimonial_img3.jpg"> 
                          <h4 class="sub-title client-title">- Joseph deboungawer - </h4>
                        </div>
                        <div class="quote right-side">
                          <div class="quote1-img">
